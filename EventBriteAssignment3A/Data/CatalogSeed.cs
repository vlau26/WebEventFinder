    ...
    public static class CatalogSeed
    {
        ...
        private static IEnumerable<CatalogItem> GetPreConfiguredCatalogItems()
        {
            return new List<CatalogItem>()
            {
                ...
                new CatalogItem() {EventId=1,CatalogLocationId=1,
                ...
                " converging during the dog days of summer in the Pike/Pine corridor Located at 925 East Pike Street, Seattle, WA 98122",
            ...
            // [event 2 - outdoor]_ 1000 Lights Water Lantern Festival 
                new CatalogItem() { EventId =4,CatalogLocationId=1,
                ...
                "Schedule: Gates open: 6:00 PM Festival: 6:00 PM - 9:00 PM Live Entertainment: 7:30-8:30 PM Lantern Launch Window: 9:15 PM - 10:00 PM", 
                ...
                new CatalogItem() { EventId =4,CatalogLocationId=3,
                ...
                " This hike will be dog-friendly! Please bring plenty of water,sunscreen, appropriate clothing for the weather.Located at Des Plaines River Trail",
                ...
                new CatalogItem() {EventId = 4,CatalogLocationId = 2,
                ...
                new CatalogItem() {EventId = 3,CatalogLocationId = 3,
                ...
                "The festival ends each night at 9:00PM. Located at 2400 S.State St., Chicago, IL 60616",
                ...
                new CatalogItem() {EventId = 3,CatalogLocationId = 1,
                ...
                new CatalogItem() {EventId = 3,CatalogLocationId = 2,
                ...
                "and make confident purchases with your new, topical insights. Meet us at LearnAboutWine loft located at 530 Molino St. #218, Los Angeles, CA 90013.",
                ...
                "STRICTLY 21 and older: No exceptions.Public transportation is highly encouraged!Meet us at The Hyde located at 5115 S Harper Ave, Chicago, IL 60615.",
                ...
                "The pierogi will be cooked and you will be able to take home your handmade products! Located at 405 Union St., Seattle, WA 98101.",
                ...
                new CatalogItem() { EventId = 2,CatalogLocationId = 1,
                ...
                "and be here meow.Located 1225 N 45th Street, Seattle, WA 98103.",
                ...
                new CatalogItem() {EventId = 2,CatalogLocationId = 2,
                ...
                " and DIY projects for all ages! Located at 3782 West Martin Luther King Junior Boulevard, Los Angles, CA 90008.",
                ...
                " see a sample lesson in action and get answers for any questions you may have. Located at 5408 Kester Avenue Sherman Oaks, CA 91411.",
                ...
                new CatalogItem() {EventId = 1,CatalogLocationId = 3,
                ...
                "even as she begins to see through his scheme at the The Goodman Theatre Located it at 170 N Dearborn St, Chicago, IL 60601.",
